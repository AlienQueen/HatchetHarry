...
public class DeckFinderQueryBuilder
{
	...
	public String buildHql()
	{
		...
		hql.append("from Deck target where 1=1 ");
		if (this.filter.getPlayerId() != null)
		{
			this.addMatchingCondition(hql, this.filter.getPlayerId().toString(), "playerId");
		}
		else
		{
			this.addMatchingCondition(hql, "*", "playerId");
		}
	...
	public void setFilter(final Deck _filter)
	{
		if (_filter == null)
		{
