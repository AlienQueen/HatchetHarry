...
(function($, undefined) {
					...
					$.ui.mouse,
					{
						...
						destroy : function() {
							if (!this.element.data('draggable'))
								return;
							this.element.removeData("draggable").unbind(
						...
						_mouseStop : function(event) {
							...
							// if the original element is removed, don't bother
							// to continue if
						...
						_getHandle : function(event) {
							...
							var handle = !this.options.handle
									|| !$(this.options.handle, this.element).length ? true
									: false;
							$(this.options.handle, this.element).find("*")
						...
						_createHelper : function(event) {
							...
							var o = this.options;
							var helper = $.isFunction(o.helper) ? $(o.helper
						...
						_getParentOffset : function() {
							...
							// scroll parent, and the
							// scroll parent isn't the document, which means
							// that
							...
							if ((this.offsetParent[0] == document.body) // This
									// needs
									// to be
									// actually
									...
									|| (this.offsetParent[0].tagName
											&& this.offsetParent[0].tagName
													.toLowerCase() == 'html' && $.browser.msie)) // Ugly
								// IE
								// fix
								po = {
									top : 0,
						...
						_convertPositionTo : function(d, pos) {
							...
							var o = this.options, scroll = this.cssPosition == 'absolute'
									&& !(this.scrollParent[0] != document && $.ui
						...
						_trigger : function(type, event, ui) {
							...
							if (type == "drag")
								this.positionAbs = this
										._convertPositionTo("absolute"); // The
							// absolute
							// position
							// has
							// to
			...
			.add(
					...
					"connectToSortable",
					{
						...
						stop : function(event, ui) {
							...
							var inst = $(this).data("draggable"), uiSortable = $
									.extend({}, ui, {
										item : inst.element
									});
						...
						drag : function(event, ui) {
							...
							var checkPos = function(o) {
								...
								return $.ui.isOver(helperTop + dyClick,
										helperLeft + dxClick, itemTop,
									...
									.each(
											...
											function(i) {
												...
												if (this.instance
													...
													// fire the drag
													// event of the sortable on
													// every draggable drag,
													// when it
													// intersects with the
													// sortable
	...
	$.ui.plugin.add("draggable", "stack", {
		start : function(event, ui) {
			...
			var group = $.makeArray($(o.stack)).sort(
					function(a, b) {
