jQuery(document).ready(
		function() {
			...
			function onEweContextMenuClick(p_sType, p_aArgs) {
				 ...
				 * the "click" event handler is the MenuItem instance that the
			...
			/*
			 * Array of text labels for the MenuItem instances to be added to e
			 * ContextMenu instanc.
			 */
			 ...
			 * nstructor is the id for the Menu element to be created, the cond
			 * is an object literal of configuration properties.
			 */
			...
			/*
			 * Array of object literals - each containing configuration operties
			 * for the items for the context menu.
			 */
