    ...
    [
								{
									action: 'click',
									target : "tour_1",
									name : "This is the menubar. Here, you can find most of the functionalities of HatchetHarry, logically grouped into menu entries."
								},
								{
									action: 'click',
									target : "tour_2",
									name : "This a card on the battlefield. You can drag and drop it using the small, green handle on its left bottom. If you do so, your opponent will see its new position reflected on his own browser. And you can have a context menu when you right-click on the card. Last but not least, you can see a full-sized card just by hovering on it."
								}
