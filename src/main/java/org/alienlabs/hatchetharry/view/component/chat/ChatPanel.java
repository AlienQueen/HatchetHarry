...
public class ChatPanel extends Panel
{
	...
	public ChatPanel(final String id, final IPushServiceRef<?> pushServiceRef)
	{
		...
		formChat.add(this.sendMessage = new AjaxButton("send", formChat)
		{
			...
			protected void onSubmit(final AjaxRequestTarget target, final Form<?> form)
			{
				...
				ServiceLocator.getChatService().getChatRoom(chatRoomName)
		...
		final IPushNode<Message> pushNode = pushServiceRef.get().installNode(this,
				new AbstractPushEventHandler<Message>()
				{
					...
					@Override
					public void onEvent(final AjaxRequestTarget target, final Message _message,
	...
	String _renderMessage(final Message msg)
	{
