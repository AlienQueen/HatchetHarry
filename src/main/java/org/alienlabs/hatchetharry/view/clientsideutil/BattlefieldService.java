...
public class BattlefieldService
{
	...
	public static final String REACTIVATE_BATTLEFIELD_JAVASCRIPT = "window.setTimeout(function() { jQuery('#galleryParent').find('.cards').sortable({ placeholder: \"ui-state-highlight\"}); jQuery('.maximize').click(function() { jQuery(this).toggleClass('details'); $(this).parents('.cardContainer').toggleClass('details'); }); }, 2000); ";
