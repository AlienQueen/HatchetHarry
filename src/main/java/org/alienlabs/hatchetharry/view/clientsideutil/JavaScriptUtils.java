...
public class JavaScriptUtils
{
	...
	public static final String REACTIVATE_HAND_COMPONENT_JAVASCRIPT = "window.setTimeout(function() { jQuery('#galleryParent').find('.cards').sortable({ placeholder: \"ui-state-highlight\"}); }, 1000); ";
