...
public class JavaScriptUtils
{
	...
	public static final String REACTIVATE_HAND_COMPONENT_JAVASCRIPT = "window.setTimeout(function() { jQuery('#galleryParent').find('.cards').sortable({ placeholder: \"ui-state-highlight\"}); function tooltips() { if ((typeof dontZoom === 'undefined') || (!dontZoom)) { $(this).parents('.cardContainer').toggleClass('details'); } } jQuery('.magicCard').click(tooltips); }, 2000); ";
