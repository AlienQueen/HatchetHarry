...
public final class JavaScriptUtils
{
	...
	public static final String DEACTIVATE_ACCEPT_END_OF_TURN_LINK = "jQuery('#acceptEndTurnLink').attr('style', 'cursor: wait; color: black;'); ";
	public static final String REACTIVATE_ACCEPT_END_OF_TURN_LINK = "jQuery('#acceptEndTurnLink').attr('style', 'cursor: pointer; color: white;'); ";
