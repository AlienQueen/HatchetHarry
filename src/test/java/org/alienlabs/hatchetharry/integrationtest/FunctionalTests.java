...
public class FunctionalTests {
    ...
    public void testFullAppTraversal() throws InterruptedException {
        ...
        assertFalse(FunctionalTests.chromeDriver2.findElements(By.cssSelector(".magicCard"))
                .get(2).getAttribute("style").contains("transform"));
        assertFalse(FunctionalTests.chromeDriver1.findElements(By.cssSelector(".magicCard"))
                .get(2).getAttribute("style").contains("transform"));
        ...
        new WebDriverWait(FunctionalTests.chromeDriver2, 10).until(ExpectedConditions
                .presenceOfElementLocated(By.cssSelector(".clickableCard")));
        assertTrue(FunctionalTests.chromeDriver2.findElements(By.cssSelector(".magicCard"))
                .get(1).findElement(By.cssSelector(".clickableCard")).getAttribute("style")
                .contains("rotate(90deg)"));
        assertTrue(FunctionalTests.chromeDriver1.findElements(By.cssSelector(".magicCard"))
                .get(1).findElement(By.cssSelector(".clickableCard")).getAttribute("style")
                .contains("rotate(90deg)"));
        ...
        assertFalse(FunctionalTests.chromeDriver2.findElements(By.id("exile-page-wrap"))
                .isEmpty());
        new WebDriverWait(FunctionalTests.chromeDriver2, 10).until(ExpectedConditions
