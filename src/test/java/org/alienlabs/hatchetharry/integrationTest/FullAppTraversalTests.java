...
public class FullAppTraversalTests
{
	...
	private static WebDriver fiefoxDriver2;
	...
	public static void setUpClass() throws InterruptedException
	{
		...
		FullAppTraversalTests.fiefoxDriver2 = new FirefoxDriver();

		FullAppTraversalTests.firefoxDriver1.manage().timeouts()
				.implicitlyWait(30, TimeUnit.SECONDS);
		FullAppTraversalTests.fiefoxDriver2.manage().timeouts()
				.implicitlyWait(30, TimeUnit.SECONDS);
		...
		FullAppTraversalTests.fiefoxDriver2.get(FullAppTraversalTests.HOST + ":"
				+ FullAppTraversalTests.PORT + "/");
	...
	public static void tearDownClass()
	{
		...
		FullAppTraversalTests.fiefoxDriver2.quit();
	}
	...
	public void testFullAppTraversal() throws InterruptedException
	{
		...
		FullAppTraversalTests.waitForJQueryProcessing(FullAppTraversalTests.fiefoxDriver2, 15);

		((JavascriptExecutor)FullAppTraversalTests.fiefoxDriver2)
				.executeScript(FullAppTraversalTests.SHOW_AND_OPEN_MOBILE_MENUBAR);

		FullAppTraversalTests.fiefoxDriver2.findElement(By.id("joinGameLinkResponsive")).click();
		Thread.sleep(8000);
		FullAppTraversalTests.fiefoxDriver2.findElement(By.id("name")).clear();
		FullAppTraversalTests.fiefoxDriver2.findElement(By.id("name")).sendKeys("Marie");
		new Select(FullAppTraversalTests.fiefoxDriver2.findElement(By.id("sideInput")))
				.selectByVisibleText("ultraviolet");
		new Select(FullAppTraversalTests.fiefoxDriver2.findElement(By.id("decks")))
				.selectByVisibleText("Aura Bant");
		FullAppTraversalTests.fiefoxDriver2.findElement(By.id("gameIdInput")).clear();
		FullAppTraversalTests.fiefoxDriver2.findElement(By.id("gameIdInput")).sendKeys(gameId);

		FullAppTraversalTests.fiefoxDriver2.findElement(By.id("joinSubmit")).click();
		...
		Assert.assertEquals(2,
				FullAppTraversalTests.firefoxDriver1.findElements(By.cssSelector(".magicCard"))
						.size());
		Assert.assertEquals(2,
				FullAppTraversalTests.fiefoxDriver2.findElements(By.cssSelector(".magicCard"))
						.size());
		...
		Assert.assertEquals(7,
				FullAppTraversalTests.firefoxDriver1.findElements(By.cssSelector(".movers-row"))
						.size());
		Assert.assertEquals(7,
				FullAppTraversalTests.fiefoxDriver2.findElements(By.cssSelector(".movers-row"))
						.size());
		...
		Assert.assertFalse(FullAppTraversalTests.firefoxDriver1
				...
				.contains("transform"));
		Assert.assertFalse(FullAppTraversalTests.fiefoxDriver2
				.findElements(By.cssSelector("img[id^='card']")).get(0).getAttribute("style")
				.contains("transform"));
		...
		Assert.assertTrue(FullAppTraversalTests.fiefoxDriver2
				.findElements(By.cssSelector("img[id^='card']")).get(0).getAttribute("style")
				.contains("rotate(90deg)"));
		...
		Assert.assertTrue(topCardName.equals(FullAppTraversalTests.fiefoxDriver2.findElement(
				By.id("topLibraryCard")).getAttribute("name")));

		// Click on the button "Do nothing"
		FullAppTraversalTests.firefoxDriver1.findElement(By.id("doNothing")).click();
		FullAppTraversalTests.fiefoxDriver2.findElement(By.id("doNothing")).click();
		Thread.sleep(8000);
