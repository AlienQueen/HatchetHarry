...
//		FullAppTraversalTests.firefoxDriver2.getPageSource();
	...
	public void testFullAppTraversal() throws InterruptedException
	{
		...
		FullAppTraversalTests.firefoxDriver.findElement(By.id("createGameLinkResponsive")).click();
		Thread.sleep(8000);
		FullAppTraversalTests.firefoxDriver.findElement(By.id("name")).clear();
		FullAppTraversalTests.firefoxDriver.findElement(By.id("name")).sendKeys("Zala");
		...
		final String gameId = FullAppTraversalTests.firefoxDriver.findElement(By.id("gameId"))
				.getText();

		FullAppTraversalTests.firefoxDriver.findElement(By.id("createSubmit")).click();
		Thread.sleep(8000);
		...
		new Select(FullAppTraversalTests.htmlUnitDriver.findElement(By.id("decks")))
				.selectByVisibleText("Aura Bant");
		FullAppTraversalTests.htmlUnitDriver.findElement(By.id("gameIdInput")).clear();
		FullAppTraversalTests.htmlUnitDriver.findElement(By.id("gameIdInput")).sendKeys(gameId);

		FullAppTraversalTests.htmlUnitDriver.findElement(By.id("joinSubmit")).click();
		...
		new Select(
				FullAppTraversalTests.firefoxDriver.findElement(By.id("putToZoneSelectForHand")))
		...
		new Select(FullAppTraversalTests.firefoxDriver.findElement(By
